...
class _FakeIOSink_2 extends _i1.SmartFake implements _i3.IOSink {
  _FakeIOSink_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeEncoding_3 extends _i1.SmartFake implements _i4.Encoding {
  _FakeEncoding_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockStdin extends _i1.Mock implements _i3.Stdin {
  ...
  set echoMode(bool? echoMode) => super.noSuchMethod(
    Invocation.setter(#echoMode, echoMode),
    returnValueForMissingStub: null,
  );

  @override
  set echoNewlineMode(bool? echoNewlineMode) => super.noSuchMethod(
    Invocation.setter(#echoNewlineMode, echoNewlineMode),
    returnValueForMissingStub: null,
  );

  @override
  set lineMode(bool? lineMode) => super.noSuchMethod(
    Invocation.setter(#lineMode, lineMode),
    returnValueForMissingStub: null,
  );
  ...
  @override
  _i2.Future<List<int>> get single =>
      (super.noSuchMethod(
  ...
  String? readLineSync({
    ...
    bool? retainNewlines = false,
      ...
      (super.noSuchMethod(
            Invocation.method(#readLineSync, [], {
              #encoding: encoding,
  ...
  int readByteSync() =>
      (super.noSuchMethod(
            Invocation.method(#readByteSync, []),
            returnValue: 0,
  ...
  _i2.StreamSubscription<List<int>> listen(
    ...
    bool? cancelOnError,
      ...
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _FakeStreamSubscription_0<List<int>>(
              this,
              Invocation.method(
                #listen,
                [onData],
  ...
  _i2.Stream<List<int>> asBroadcastStream({
    ...
    void Function(_i2.StreamSubscription<List<int>>)? onCancel,
      ...
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i2.Stream<List<int>>.empty(),
          )
  ...
  _i2.Future<List<List<int>>> toList() =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i2.Future<List<List<int>>>.value(
              <List<int>>[],
            ),
          )
  ...
  _i2.Future<Set<List<int>>> toSet() =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i2.Future<Set<List<int>>>.value(
              <List<int>>{},
            ),
          )
  ...
  @override
  _i2.Future<List<int>> elementAt(int? index) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockStdout extends _i1.Mock implements _i3.Stdout {
  @override
  bool get hasTerminal =>
      (super.noSuchMethod(
            Invocation.getter(#hasTerminal),
  ...
  int get terminalColumns =>
      (super.noSuchMethod(
            Invocation.getter(#terminalColumns),
            returnValue: 0,
            returnValueForMissingStub: 0,
          )
          as int);
  ...
  int get terminalLines =>
      (super.noSuchMethod(
            Invocation.getter(#terminalLines),
            returnValue: 0,
            returnValueForMissingStub: 0,
          )
          as int);
  ...
  @override
  _i3.IOSink get nonBlocking =>
      (super.noSuchMethod(
            Invocation.getter(#nonBlocking),
            returnValue: _FakeIOSink_2(this, Invocation.getter(#nonBlocking)),
            returnValueForMissingStub: _FakeIOSink_2(
              this,
              Invocation.getter(#nonBlocking),
            ),
          )
  ...
  String get lineTerminator =>
      (super.noSuchMethod(
            Invocation.getter(#lineTerminator),
  ...
  _i4.Encoding get encoding =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeEncoding_3(this, Invocation.getter(#encoding)),
            returnValueForMissingStub: _FakeEncoding_3(
              this,
              Invocation.getter(#encoding),
            ),
          )
  ...
  @override
  set lineTerminator(String? lineTerminator) => super.noSuchMethod(
    Invocation.setter(#lineTerminator, lineTerminator),
    returnValueForMissingStub: null,
  );

  @override
  set encoding(_i4.Encoding? encoding) => super.noSuchMethod(
    Invocation.setter(#encoding, encoding),
    returnValueForMissingStub: null,
  );
  ...
  void writeAll(Iterable<dynamic>? objects, [String? sep = '']) =>
      super.noSuchMethod(
        Invocation.method(#writeAll, [objects, sep]),
        returnValueForMissingStub: null,
      );
